...
fixed_hash::construct_fixed_hash! {
	/// Hash type used in Pass3dt chain.
	#[derive(MallocSizeOf, TypeInfo)]
	pub struct Pass3dtHash(64);
}

#[cfg(feature = "std")]
impl_serde::impl_fixed_hash_serde!(Pass3dtHash, 64);

impl_codec::impl_fixed_hash_codec!(Pass3dtHash, 64);

impl CheckEqual for Pass3dtHash {
	#[cfg(feature = "std")]
